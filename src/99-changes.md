...
| ------------------------------ | ---------------------------------------------------------- | ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| **List Tanpa Elemen Terakhir** | `Head(L)`                                                  | `tail(L)`                                                                | Istilah `Head` pada versi lama berkebalikan dengan konvensi bahasa fungsional modern (di mana `head` berarti elemen pertama). |
